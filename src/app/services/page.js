    ...
    return (
        <div>
            ...
            <div className='my-10 flex justify-around w-full items-center'>
                ...
                <button className='bg-base-200 px-5 py-2 rounded-full font-bold text-sm'>+ Add Service</button>
            </div>
            <div className='text-center'>
            <Image className='w-2/5 mx-auto' src={womenBanner}/>
            <p className='font-mono mb-5'>Create a 1:1 Service</p>
            <Link href="/" className='px-8 py-2 bg-gradient-to-t from-[#358279] to-[#27EDD5] text-sm font-bold text-white rounded-full shadow-sm'>+ ADD</Link>
            </div>
